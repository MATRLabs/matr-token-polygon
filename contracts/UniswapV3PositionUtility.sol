...
contract UniswapV3PositionUtility is Ownable {
    ...
    function setMATRContract(address _matrContract) external onlyOwner {
        require(_matrContract != address(0), "Zero address");
        matrContract = _matrContract;
    }
    ...
    function getMATRAmount(uint256 tokenID) public view returns (uint256) {
        int24 tickUpper;
        int24 tickLower;
        uint128 liquidity;
        address token0;
